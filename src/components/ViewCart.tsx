...
const ViewCart = () => {
    ...
    return (
        <div className={`flex flex-col pt-5 ${!carts.length && "h-screen"}`}>
            <h1 className="text-center text-2xl font-bold mb-3">Your Shopping Cart</h1>
            ...
            {!carts.length ? (
                ...
                <div className="flex flex-col space-y-5">
                    {carts.map((cart) => (
                        ...
                        >
                            <Image src={cart.image} alt={cart.title} width={250} height={250} />
            ...
            <h2 className={`${!carts.length && "hidden"} px-10 mt-5 mb-20 font-extrabold text-xl`}>
