...
const Cart = ({ cart }: CartProps) => {
    const { deleteSingleCart, incrementQuantity, decrementQuantity, quantity } = useCart();
        ...
        <div className="my-5">
            ...
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-x-3">
                    <button onClick={decrementQuantity} className="bg-black w-9 h-9 text-white">
                        -
                    </button>
                    <p>{quantity}</p>
                    <button onClick={incrementQuantity} className="bg-black w-9 h-9 text-white">
                        +
                    </button>
                </div>
